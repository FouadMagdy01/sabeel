...
export function getSurahForPage(page: number): Surah | undefined {
  return SURAHS.find((s) => page >= s.pages[0] && page <= s.pages[1]);
}

export function getAllSurahsForPage(page: number): Surah[] {
  return SURAHS.filter((s) => page >= s.pages[0] && page <= s.pages[1]);
}
