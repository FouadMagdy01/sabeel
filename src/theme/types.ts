...
/**
 * Component-Specific Colors - Specialized UI components
 */
export interface ComponentColors {
  /**
   * Switch/Toggle track color (inactive)
   * @usage Toggle switch background when off
   * @examples Settings toggles, feature switches
   */
  switchTrackOff: string;

  /**
   * Switch/Toggle track color (active)
   * @usage Toggle switch background when on
   * @examples Active settings toggles
   */
  switchTrackOn: string;

  /**
   * Switch/Toggle thumb color
   * @usage Toggle switch thumb/handle
   * @examples Toggle handle in both states
   */
  switchThumb: string;

  /**
   * Checkbox unchecked border
   * @usage Border of unchecked checkbox
   * @examples Form checkboxes, selection controls
   */
  checkboxBorder: string;

  /**
   * Checkbox checked background
   * @usage Background of checked checkbox
   * @examples Selected checkboxes
   */
  checkboxChecked: string;

  /**
   * Radio button unchecked border
   * @usage Border of unchecked radio button
   * @examples Form radio buttons, option selectors
   */
  radioBorder: string;

  /**
   * Radio button checked background
   * @usage Background of checked radio button
   * @examples Selected radio buttons
   */
  radioChecked: string;

  /**
   * Slider track (inactive portion)
   * @usage Inactive portion of slider track
   * @examples Volume slider, settings slider
   */
  sliderTrackInactive: string;

  /**
   * Slider track (active portion)
   * @usage Active portion of slider track
   * @examples Completed portion of slider
   */
  sliderTrackActive: string;

  /**
   * Slider thumb
   * @usage Slider thumb/handle
   * @examples Slider draggable handle
   */
  sliderThumb: string;

  /**
   * Progress bar track
   * @usage Background track of progress bar
   * @examples Loading bars, progress indicators
   */
  progressTrack: string;

  /**
   * Progress bar fill
   * @usage Filled portion of progress bar
   * @examples Loading progress, completion indicator
   */
  progressFill: string;

  /**
   * Tab bar background
   * @usage Background of bottom tab navigation
   * @examples Main app navigation bar
   */
  tabBarBackground: string;

  /**
   * Tab bar border
   * @usage Top border of tab bar
   * @examples Navigation bar separator
   */
  tabBarBorder: string;

  /**
   * Badge background
   * @usage Background of notification badges
   * @examples Unread count badges, notification indicators
   */
  badgeBackground: string;

  /**
   * Badge text
   * @usage Text color in badges
   * @examples Badge numbers, notification text
   */
  badgeText: string;

  /**
   * Chip/Tag background
   * @usage Background of chips and tags
   * @examples Category tags, filter chips, topic tags
   */
  chipBackground: string;

  /**
   * Chip/Tag text
   * @usage Text in chips and tags
   * @examples Tag labels, chip text
   */
  chipText: string;
...
/**
 * Islamic App Specific Colors - Specialized for religious features
 */
export interface IslamicColors {
  /**
